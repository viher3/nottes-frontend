...
import {UpdateFolderView} from "../../Views/Folder/Update/UpdateFolderView";

export const ROUTE_PATHS = {
    DASHBOARD : "/",
    VIEW_FOLDER : "/folder/:id",
    CREATE_FOLDER : "/folder/:parentId/create",
    UPDATE_FOLDER : "/folder/:id/update",
}
...
export const AppRoutes = () => {
    return useRoutes([
        ...
        {path: ROUTE_PATHS.UPDATE_FOLDER, element: <UpdateFolderView/>},
    ])
};
